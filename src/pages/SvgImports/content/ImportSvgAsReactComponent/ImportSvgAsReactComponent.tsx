import { ReactComponent as ViteIconComponent } from '../../../../assets/vite2.svg';
import CodeBlock from '../../../../components/CodeBlock';

export default function ImportSvgAsReactComponent() {
  return (
    <section className='border border-gray-300 dark:border-gray-700 rounded-lg p-6'>
      <h2 className='text-2xl font-semibold mb-4'>Method 2: Import as React Component</h2>

      <div className='flex flex-col gap-4'>
        <CodeBlock code={`import { ReactComponent as ViteIconComponent } from '../../../../assets/vite2.svg';`} />

        {/* If exportType is 'default', switch Comment on these 2 lines: */}
